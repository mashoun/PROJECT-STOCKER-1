<template>
    <header
        ...
        <section class="d-flex align-items-center gap-3">
            ...
            <span class="material-symbols-outlined fs-4 text-secondary" role="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasMenu" aria-controls="offcanvasMenu">menu</span>
        </section>
